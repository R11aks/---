...
namespace StudentAppWPF.Data
{
    public class StudentRepository
    {
        ...
        // Получить всех студентов (через представление)
        ...
        // Поиск/фильтрация через хранимую процедуру
        ...
        // Вспомогательный метод отображения данных из IDataReader
